    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default=0, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(blank=True, max_length=(23, 59, 59), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, max_length=200, null=True)),
                ('api_key', models.CharField(blank=True, max_length=201, null=True)),
                ('recipients', models.TextField(max_length=1000, null=True)),
                ('message', models.TextField(max_length=200, null=True)),
                ('sender_id', models.CharField(blank=True, max_length=200, null=True)),
                ('topup_amount', models.CharField(max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Group',
            fields=[
                ...
                ('contact', models.ManyToManyField(to='counter1app.Profile')),
            ],
        ),
    ]
